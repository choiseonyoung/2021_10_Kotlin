...
fun main() {
    ...
    // 정말 null값을 처리하고 싶은 경우 safe null 이라는 형식을 사용
    // 1. 표준 문법으로 변수를 선언한다 : type을 강제 지정하여 선언
    // 2. type 키워드 뒤에 ?(safe null) 기호를 첨가
    // 3. safe null 형식으로 강제를 null을 저장할 수 있다
